...
using si730pc2u202214059.API.Sales.Application.Internal.CommandService;
using si730pc2u202214059.API.Sales.Domain.Repositories;
using si730pc2u202214059.API.Sales.Domain.Services;
using si730pc2u202214059.API.Sales.Infrastructure.Exception;
using si730pc2u202214059.API.Sales.Infrastructure.Persistence.EFC.Repositories;
...
builder.Services.AddSwaggerGen(
    c =>
    {
        c.SwaggerDoc("v1",
            new OpenApiInfo
            {
                Title = "si730pc2u202214059.API",
                Version = "v1",
                Description = " si730pc2u202214059.API by Ian Haziel Donato Santisteban Palomino",
                TermsOfService = new Uri("https://www.cottonknit.com/"),
                Contact = new OpenApiContact
                {
                    Name = "u202214059",
                    Email = "u202214059@upc.edu.pe"
                },
